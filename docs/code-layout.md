...
docs/
  ...
  compliance-templates/             -- starter tenant-config-bundle JSON files (Risk Register, Subprocessor Register, PIV/CAC Card issuance, Software License, Cloud Environment, Encryption Key/Certificate, System Interconnection, Contractor Access, Data Inventory, POA&M tracking fields, Nessus finding fields)
```
